import {
  deskTool,
  require_isNumber
} from "/build/_shared/chunk-5WXPSLY2.js";
import {
  Box,
  Button,
  Card,
...
var visionTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      component: (0, import_react3.lazy)(() => import("/build/_shared/SanityVision-ac7189c6-IFFW2NN4.js")),
      options: config2,
      router: route.create("/*")
    }]
  };
...
var j = "desktop";
function w(e2) {
  const { document: n2, options: w2 } = e2, { url: k, defaultSize: x = j, reload: P, attributes: S = {} } = w2, [z, C] = (0, import_react36.useState)(k && "string" == typeof k ? k : ""), [D, E] = (0, import_react36.useState)((null == O ? void 0 : O[x]) ? x : j), B = (0, import_react36.useRef)(null), H = (0, import_react36.useRef)(null), { displayed: R } = n2, [, _] = useCopyToClipboard_default();
  function I() {
  ...
  }, [R._rev, null == P ? void 0 : P.revision]), (0, import_react36.useEffect)(() => {
...
//# sourceMappingURL=/build/routes/studio/$-J4X3PAX5.js.map
